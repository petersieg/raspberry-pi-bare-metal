...
/*
As you may know, there's an undocumented random number generator on the BCM2835 chip. 
All I could google about it is this not so detailed doc and this messy linux driver source.

I thought it would be benefitial to have a single C function usage example, so here it is:
*/
#define MMIO_BASE 0x20000000 //rpi 1
//#define MMIO_BASE 0x3F000000 //rpi 2+3
//#define MMIO_BASE 0xFE000000 //rpi 4
